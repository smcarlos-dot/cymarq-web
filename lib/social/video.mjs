...
/**
 * Historia de Instagram (`media_type=STORIES`).
 *
 * Se diferencia de un Reel en dos cosas que importan aqui: el tope de duracion
 * es 60 s en vez de 900, y el archivo no puede pasar de 100 MB. Lo que sobra de
 * esos 60 s no se recorta: Meta rechaza el contenedor entero.
 *
 * El rango de relacion de aspecto es el mismo de amplio que en Reels porque
 * Instagram tampoco lo impone; fuera de 9:16 la historia sale con bandas, y eso
 * es un aviso, no un problema.
 */
export const REGLAS_INSTAGRAM_HISTORIA = {
  plataforma: 'instagram',
  formato: 'stories',
  contentTypes: ['video/mp4', 'video/quicktime'],
...
/**
 * Historia de la Pagina de Facebook (`/video_stories`).
 *
 * Tan estricta como un Reel de Facebook en aspecto y resolucion minima, pero
 * con el tope de 60 s de las historias. Es la mas restrictiva de las cuatro:
 * un video que pasa esta pasa las demas.
 */
export const REGLAS_FACEBOOK_HISTORIA = {
  plataforma: 'facebook',
  formato: 'stories',
  contentTypes: ['video/mp4', 'video/quicktime'],
  maxBytes: 100 * 1024 * 1024,
...
export const REGLAS = {
  ...
  'instagram:stories': REGLAS_INSTAGRAM_HISTORIA,
  'facebook:reels': REGLAS_FACEBOOK_REEL,
  'facebook:stories': REGLAS_FACEBOOK_HISTORIA,
