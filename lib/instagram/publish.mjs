 ...
 * cuenta @cymarq_obras). Host `graph.instagram.com`, token de usuario de
 ...
 *
 * ESTADO: este módulo contiene ÚNICAMENTE operaciones de LECTURA y de
 * validación local. No existe aquí ninguna función que cree un contenedor de
 * medios ni que publique. Ejecutar cualquier cosa de este archivo no puede
 * hacer aparecer una publicación en Instagram.
 *
